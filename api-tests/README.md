...
**55 request, 132 assertion**, sekitar 2 detik.
...
| 04 Owner | Void wajib alasan, void berhasil, void kedua tidak diproses ulang, supplier tanpa CSRF / tanpa nama ditolak, `return_to` ke domain luar diabaikan (tidak ada open redirect), produk dengan harga jual Rp0 ditolak |
